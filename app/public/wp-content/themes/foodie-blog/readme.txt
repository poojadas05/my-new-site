...
Foodie Blog WordPress Theme, Copyright 2018 ThemeEverest
Foodie Blog is distributed under the terms of the GNU GPL
All files coded by me, and fonts (for example Foodie Blog font) is under GPLv2 http://www.gnu.org/licenses/gpl-2.0.html

Foodie Blog bundles the following third-party resources:
...
IMG FROM SCREENSHOT
CC0 License
https://pixabay.com/en/platter-food-delicious-food-2009590/
...
* Font: Foodie Blog Fonts (foodie-blog can be found in /fonts)
	License: SIL OFL 1.1
	License: CC0 License
