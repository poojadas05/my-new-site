 ...
 */
function foodie_blog_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'top_header_background_color', array(
        'label'       => __( 'Header Background Color', 'foodie-blog' ),
        'description' => __( 'Applied to header background.', 'foodie-blog' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'general_theme_color', array(
        'label'       => __( 'General Theme Color', 'foodie-blog' ),
        'section'     => 'colors',
        'priority'   => 10,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'navigation_frontpage_link_color', array(
        'label'       => __( 'Navigation Link Color', 'foodie-blog' ),
        'section'     => 'colors',
        'priority'   => 1,
    ...
    $wp_customize->get_section('header_image')->title = __( 'Header', 'foodie-blog' );
    $wp_customize->get_control( 'header_textcolor'  )->section   = 'header_image';

}
add_action( 'customize_register', 'foodie_blog_customize_register' );

if(! function_exists('foodie_blog_user_customization_customizer' ) ):
    function foodie_blog_user_customization_customizer(){
  ...
  .corner { border-color: transparent transparent <?php echo esc_attr(get_theme_mod( 'general_theme_color')); ?> transparent;}
        ...
        .post-date-foodie, .comment time { color: <?php echo esc_attr(get_theme_mod( 'post_page_date')); ?>; }
        ...
        <?php }
        add_action( 'wp_head', 'foodie_blog_user_customization_customizer' );
        endif;

/**
 * Binds JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function foodie_blog_customize_preview_js() {
   wp_enqueue_script( 'foodie_blog_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'foodie_blog_customize_preview_js' );
